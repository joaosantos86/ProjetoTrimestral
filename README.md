...
> 📚 This project was built for educational purposes only as a school assignment.

A gaming peripherals e-commerce built with Vue 3 as a school project, applying DDD (Domain Driven Design) architecture as a study practice.
...
- [ ] Product detail page
- [ ] Checkout with ZIP code auto-fill
- [ ] Order summary
...
│       └── services/                # Domain operations
│           └── cepService.js        # Fetches address data from Correios API
...
based on a ZIP code (CEP) through the Correios API.

| File | Responsibility |
|---|---|
| `Address.js` | Address entity defining the fields contract |
| `cepService.js` | Fetches address data from the Correios external API |
...
- [ ] Integrate Correios API for ZIP code lookup
- [ ] Add product detail page (`ProductDetailView.vue`)
- [ ] Add checkout page (`CheckoutView.vue`) with address form
- [ ] Add product search and filtering on catalog page
- [ ] Add order summary after checkout
